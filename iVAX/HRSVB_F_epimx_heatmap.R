...
list2<-str_sort(c(colnames(HRSVB_F_heatmap4)), numeric = TRUE)
list2

HRSVB_F_heatmap5<-HRSVB_F_heatmap4[list2]
write.csv(HRSVB_F_heatmap5,"iVAX/HRSVB_F_classII_epimx_hp_fill.csv")
