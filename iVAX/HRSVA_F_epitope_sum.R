...
################################################################################################
## RSVA_F Class I epitope
RSVA_F_classI_data1<-read.csv("iVAX/RSVA_F/CLASS1_PROTEIN_REPORT_HRSVA_F_CLEAN0627_PROTEIN_All_Proteins_BY_9_file1.csv",
                              header = FALSE, stringsAsFactors = FALSE, sep = ",")
RSVA_F_classI_data2<-read.csv("iVAX/RSVA_F/CLASS1_PROTEIN_REPORT_HRSVA_F_CLEAN0627_PROTEIN_All_Proteins_BY_9_file2.csv",
                              header = FALSE, stringsAsFactors = FALSE, sep = ",")
RSVA_F_classI_data3<-read.csv("iVAX/RSVA_F/CLASS1_PROTEIN_REPORT_HRSVA_F_CLEAN0627_PROTEIN_All_Proteins_BY_9_file3.csv",
                              header = FALSE, stringsAsFactors = FALSE, sep = ",")
...
HRSVA_F_epimx.data1<-EMX2(RSVA_F_classI_data1,output)
HRSVA_F_epimx.data2<-EMX2(RSVA_F_classI_data2,output)
HRSVA_F_epimx.data3<-EMX2(RSVA_F_classI_data3,output)
...
write.csv(HRSVA_F.epimx.data.2,"iVAX/RSVA_F/RSVA_F_classI_analysis/RSVA_F_classI_epimax")  
#HRSVA_F.epimx.data.2<-read.csv("iVAX/HRSVA_F_classII_epimx0812.csv")
#############################################################################
...
HRSVA_F.epimx.data.3<-HRSVA_F.epimx.data.3%>% filter(HRSVA_F.epimx.data.3$Type =="T")
HRSVA_F.epimx.data.clean<-HRSVA_F.epimx.data.3[c(1:12)]
write_csv(HRSVA_F.epimx.data.clean,"iVAX/RSVA_F/RSVA_F_classI_analysis/RSVA_F_classI_epimax_clean.csv")
#####################################################################################  
...
#filter EPIBARS Hits >=4
HRSVA_F.epimx.data.3$Hits<- as.numeric(HRSVA_F.epimx.data.3$Hits)
HRSVA_F.epimx.data.4<- HRSVA_F.epimx.data.3 %>% filter(Hits >= 3)
HRSVA_F.epimx.data.4<- HRSVA_F.epimx.data.4[!(HRSVA_F.epimx.data.4$`AA.Sequence` == ""), ]
write.csv(HRSVA_F.epimx.data.4,"iVAX/RSVA_F/RSVA_F_classI_analysis/RSVA_F_classI_epimax_filter.csv")
...
## write these 445 epitope profile
write.csv(HRSVA_F_epitope_sum,"iVAX/RSVA_F/RSVA_F_classI_analysis/RSVA_F_classI_epitope_sum.csv",row.names=FALSE)
...
## reshape, change the AA Sequence value to column name
HRSVA_F.epimx.data.hp<-dcast(HRSVA_F.epimx.data.hp, Accession ~ epitope1,value.var = "code") 
write.csv(HRSVA_F.epimx.data.hp,"iVAX/RSVA_F/RSVA_F_classI_analysis/RSVA_F_classI_epitope_hp.csv",row.names=FALSE)
